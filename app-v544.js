...
try{
  window.__BK_BUILD__="V544";
  localStorage.setItem("bungou_kitan_build","V544");
}catch(_){}
...
function shell(x){
 ...
 A.innerHTML=`${premium?"":`<div class=top><b>文豪綺譚 <span class=gold>V544</span></b><small>EXP ${S.xp} / 🖋️${S.ink}</small></div>`}<div class=screenFade>${x}</div>${premium?"":nav()}`
}
...
function stagePrepPanelV524(ch){
 ...
 return `<section class=stagePrepPanelV524 stagePrepPanelV544>
   ...
   <div class=stagePrepActionsV524 stagePrepActionsV540 stagePrepActionsV544>
     <button data-stage-smart-v524="${x.mode}:${ch}">おすすめ編成<small>所持のみ</small></button>
...
function dedicatedHome(){
 ...
 shell(`<main class=premiumHomeV236>
   ...
   <div class=premiumHomeReadyBadgeV499>V544 COMPACT</div>
